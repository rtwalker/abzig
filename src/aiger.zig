...
const SymbolTable = struct {
    input_names: AutoHashMap(u32, []const u8),
    latch_names: AutoHashMap(u32, []const u8),
    output_names: AutoHashMap(u32, []const u8),
    allocator: std.mem.Allocator,

    pub fn init(allocator: std.mem.Allocator) SymbolTable {
        return .{
            .input_names = AutoHashMap(u32, []const u8).init(allocator),
            .latch_names = AutoHashMap(u32, []const u8).init(allocator),
            .output_names = AutoHashMap(u32, []const u8).init(allocator),
            .allocator = allocator,
        };
    }
